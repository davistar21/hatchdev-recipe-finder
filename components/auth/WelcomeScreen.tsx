...
export function WelcomeScreen() {
  return (
    <div className="relative flex h-screen w-full flex-col overflow-hidden max-w-md mx-auto shadow-2xl bg-background text-foreground font-display">
      ...
      <div className="flex-1 relative flex flex-col">
        ...
        <div className="relative h-[55%] w-full overflow-hidden rounded-b-[2rem]">
          ...
          {/* Logo / Brand Badge */}
          <div className="absolute top-12 left-1/2 -translate-x-1/2 bg-background/90 backdrop-blur-sm px-4 py-2 rounded-full shadow-lg flex items-center gap-2">
        ...
        <div className="flex-1 flex flex-col justify-between pt-6 pb-2">
          ...
          <div className="flex flex-col items-center px-6 text-center">
            <h1 className="text-foreground tracking-tight text-[32px] font-extrabold leading-tight pb-3">
              Taste the World
            </h1>
            ...
            <div className="w-full pt-4 overflow-x-auto hide-scrollbar pb-2 no-scrollbar">
              <div className="flex flex-row items-start justify-center gap-4 min-w-max px-2">
                <div className="flex flex-col items-center gap-2 w-20">
                  ...
                  >
                    <div className="w-full h-full rounded-full border-2 border-background"></div>
                  </div>
                  <span className="text-xs font-semibold text-center opacity-80 decoration-0">
                    Discover
                  </span>
                </div>
                <div className="flex flex-col items-center gap-2 w-20">
      ...
      <div className="w-full px-6 pb-8 pt-2 bg-background">
        ...
        {/* Terms */}
        <p className="mt-6 text-center text-[10px] text-muted-foreground leading-tight px-8">
